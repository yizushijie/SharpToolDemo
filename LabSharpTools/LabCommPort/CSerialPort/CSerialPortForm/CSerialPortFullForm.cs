...
{
	public partial class CSerialPortFullForm : CCommPortForm
	{
		#region 变量定义
		...
		public override CSerialPortParam mCCommSrialParam
		{
			get
			{
				return new CSerialPortParam(this.cCommSerial.mCCommName, this.cCommSerial.mBaudRate, this.cCommSerial.mStopBits, this.cCommSerial.mDataBits, this.cCommSerial.mParity,this.cCommSerial.mAddrID);
			}
		}
		...
		/// 构造函数
		/// </summary>
		public CSerialPortFullForm() : base()
		{
			InitializeComponent();
		}
		...
		/// 构造函数
		/// </summary>
		public CSerialPortFullForm(bool isLimitedSize = false)
		{
			InitializeComponent();
			//---判断是否限定最小尺寸
			if (isLimitedSize)
		...
		/// <param name="text"></param>
		/// <param name="isLimitedSize"></param>
		public CSerialPortFullForm(int perPackageSize, ComboBox cbb, CCommPort cComm, string text = null, bool isLimitedSize = false)
		{
			InitializeComponent();
		...
		/// <param name="text"></param>
		/// <param name="isLimitedSize"></param>
		public CSerialPortFullForm(int perPackageSize, ComboBox cbb, CCommPort cComm, RichTextBox msg = null, string text = null, bool isLimitedSize = false)
		{
			InitializeComponent();
		...
		/// <param name="cbb"></param>
		/// <param name="cComm"></param>
		private void Init(int perPackageSize, ComboBox cbb, CCommPort cComm)
		{
			if (cComm != null)
			{
				this.cCommSerial.RemoveComboBoxMouseDownClick();
