...
{
    public partial class CFloatPopupBaseForm : Form
    {
        #region 变量定义
        ...
        /// <summary>
        /// 是否锁定位置,不在移动，false---允许移动；true---不允许移动
        /// </summary>
        private bool defaultLockFrame = false;
		...
		///  限制窗体移动
		/// </summary>
		[Description("限制窗体的移动!"), Category("自定义属性")]
        public virtual bool mLockFrame
        {
            get
            {
                return this.defaultLockFrame;
            }
            set
            {
                this.defaultLockFrame = value;
            }
        }
		...
		/// 
		/// </summary>
		public CFloatPopupBaseForm(bool isControlBox)
		{
			InitializeComponent();
            //---是否显示最大最小功能
		...
		private class MouseMessageFilter : IMessageFilter
        {
            ...
            /// 
            /// </summary>
            private  CFloatPopupBaseForm defaultFloatPopupForm=null;
            ...
            public MouseMessageFilter(CFloatPopupBaseForm foatPopupBaseForm)
            {
