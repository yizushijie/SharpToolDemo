...
namespace TestAgent.GraphicsLib
{
    ...
    {
        /// <summary> 普通的笛卡尔坐标 </summary>
        Linear,
        /// <summary> 基于10的对数坐标 </summary>
        Log,
        /// <summary> 直角坐标轴与日历日期或时间,A cartesian axis with calendar dates or times </summary>
        Date,
        /// <summary> 文本的An ordinal axis with user-defined text labels.  An ordinal axis means that
        ...
        Text,
        /// <summary> 顺序的An ordinal axis with regular numeric labels.  An ordinal axis means that
        /// all data points are evenly spaced at integral values, and the actual coordinate values
        /// for points corresponding to that axis are ignored.  That is, if the X axis is an
        /// ordinal type, then all X values associated with the curves are ignored. </summary>
        ...
        Ordinal,
        /// <summary> 时间序 An ordinal axis that will have labels formatted with ordinal values corresponding
        ...
        /// <seealso cref="Scale.IsOrdinal"/>
        DateAsOrdinal,
        /// <summary> 线性序数An ordinal axis that will have labels formatted with values from the actual data
    ...
    public enum BarType
    {
        ...
        Overlay,
        /// <summary>
        /// 有序覆盖Draw the <see cref="BarItem"/> bars one on top of the other.  The bars will
        ...
        SortedOverlay,
        /// <summary>
        /// 堆叠Draw the <see cref="BarItem"/> bars in an additive format so that they stack on
    ...
    public enum FillType
    {
        ...
        None,
        /// <summary> A solid fill using "System.Drawing.SolidBrush" </summary>
        Solid,
        /// <summary> A custom fill using either "LinearGradientBrush" or
        /// "TextureBrush"</summary>
        Brush,
        /// <summary>
    ...
    {
        /// <summary> 正方形 Square-shaped <see cref="Symbol"/> </summary>
        Square,
        /// <summary> 菱形 Rhombus-shaped <see cref="Symbol"/> </summary>
        Diamond,
        /// <summary> 三角形 Equilateral triangle <see cref="Symbol"/> </summary>
        Triangle,
        /// <summary> 圆 Uniform circle <see cref="Symbol"/> </summary>
        Circle,
        ...
        Star,
        /// <summary> 倒三角形Unilateral triangle <see cref="Symbol"/>, pointing
        /// down. </summary>
        TriangleDown,
        /// <summary>
        /// 水平虚线 Horizontal dash <see cref="Symbol"/>.  This symbol cannot be
        /// filled since it has no outline.
        /// </summary>
        HDash,
        /// <summary>
        /// 垂直虚线 Vertical dash <see cref="Symbol"/>.  This symbol cannot be
        /// filled since it has no outline.
        /// </summary>
        VDash,
        /// <summary> 用户定义A symbol defined by the <see cref="Symbol.UserSymbol"/> propery.
        /// If no symbol is defined, the <see cref="Symbol.Default.Type"/>. symbol will
        /// be used.
        /// </summary>
        UserDefined,
        /// <summary> 系统默认 A Default symbol type (the symbol type will be obtained
    ...
    /// <summary>
    /// 坐标类型 Enumeration type for the user-defined coordinate types available.
    ...
    {
        /// <summary>
        /// 分数 Coordinates are specified as a fraction of the
        ...
        ChartFraction,
        /// <summary>
        ///  窗格中的分数 Coordinates are specified as a fraction of the
        ...
        PaneFraction,
        /// <summary>
        /// 座标根据用户轴标度指定 Coordinates are specified according to the user axis scales
