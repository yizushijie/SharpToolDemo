...
namespace TestAgent.GraphicsLib
{
    ...
    public class Legend : ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Private field that stores the <see cref="Fill"/> data for this
        /// <see cref="Legend"/>.  Use the public property <see cref="Fill"/> to
        /// access this value.
        /// </summary>
        private Fill _fill;
        /// <summary>
        /// Private field that stores the <see cref="Border"/> data for this
        ...
        /// <summary>
        /// Access to the <see cref="FontSpec"/> class used to render
        ...
        /// <summary>
        /// Gets or sets the <see cref="Fill"/> data for this
        ...
        /// 查找在给定点上的对象
        /// </summary>
        /// <param name="mousePt">给定的鼠标点</param>
        /// <param name="pane">图表对象</param>
        /// <param name="scaleFactor">字体比例尺</param>
        /// <returns>对象集合</returns>
        public ArrayList FindObjsOnPoint(PointF mousePt, PaneBase pane, float scaleFactor)
        {
