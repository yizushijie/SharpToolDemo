...
namespace TestAgent.GraphicsLib
{
    ...
    /// <see cref="XAxis"/>,and  <see cref="YAxis"/>, classes
    /// to define specific characteristics for those types.
    /// </remarks>
    /// 
    [Serializable]
    abstract public class Axis : ParamEditEnable, ISerializable, ICloneable
    {

        #region 类变量定义

        /// <summary>
        /// private field that stores the <see cref="Scale" /> class, which implements all the
        ...
        /// information associated with the <see cref="Axis"/>.  Example does
        ...
        /// <returns>
        /// A string value representing the label, or null if the Example should go ahead
        ...
        /// </summary>
        /// <value>Set to true to have Example put the axis in the default location, or false
        ...
        /// <summary>
        /// Gets a reference to the <see cref="MajorTic" /> class instance
        ...
        /// <summary>
        /// Gets a reference to the <see cref="MinorTic" /> class instance
        ...
        {
            return new FormAxisParamEdit(this);
        }
        #endregion 参数编辑界面
    }
}
