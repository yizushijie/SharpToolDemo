...
namespace TestAgent.GraphicsLib
{
    ...
    /// 
    [Serializable]
    abstract public class Scale : ParamEditEnable, ISerializable
    {
        #region 变量定义
        ...
        */
        ...
        /// This property may be set automatically by Example, depending on the state of
        /// <see cref="FormatAuto"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Gets or sets a <see cref="bool"/> value that determines if Example will check to
        /// see if the <see cref="Axis"/> scale labels are close enough to overlap.  If so,
        /// Example will adjust the step size to prevent overlap.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This method properly accounts for <see cref="IsLog"/>, 
        /// and other axis format settings.
        /// </remarks>
        /// <param name="baseVal">
                        ...
                        float topPix, float shift, float scaleFactor)
        {
            ...
            using (Pen ticPen = tic.GetPen(pane, scaleFactor))
            {
                ...
                for (int i = firstTic; i < nTics + firstTic; i++)
                {
                    ...
                    bool isMaxValueAtMaxPix = ((_ownerAxis is XAxis) &&
                                        !IsReverse) || (IsReverse);
