...
namespace TestAgent.GraphicsLib
{
    ...
    /// 
    [Serializable]
    abstract public class CurveItem : ParamEditEnable, ISerializable, ICloneable
    {
        ...
        */
        ...
        public void AddPoints(PointPairList points)
        {
            if (_points == null)
                this.Points = new PointPairList();

            if (_points is IPointListEdit)
                (_points as IPointListEdit).Add(points);
            else
                throw new NotImplementedException();
        }
        ...
        /// </summary>
        /// <param name="points"></param>
        public void UpdatePointsWith(PointPairList points)
        {
        ...
        virtual public void GetRange(out double xMin, out double xMax,
                                        ...
                                        bool ignoreInitial,bool isBoundedRanges,
                                        GraphPane pane)
        {
        ...
        /// <summary>
        /// 为矩形 Determine the coords for the rectangle associated with a specified point for 
